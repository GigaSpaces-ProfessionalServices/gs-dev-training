# xap-dev-training - lab14-solution
...
1.1 Open %XAP_TRAINING_HOME%/xap-dev-training-lab14-solution project with intellij (open pom.xml) <br />
1.2 Run mvn install

    ~/xap-dev-training/xap-dev-training-lab14-solution$ mvn install
...
###### This will add the predefined Run Configuration Application to your Intellij IDE.
    ...
    ~/xap-dev-training/xap-dev-training-lab14-solution$ mvn xap:intellij
