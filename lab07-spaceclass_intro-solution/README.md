# gs-dev-training - lab07-spaceclass_intro-solution
...
1.1 Open gs-dev-training/lab07-spaceclass_intro-solution project with intellij (open pom.xml) <br />
1.2 Run mvn install

    ~/gs-dev-training/lab07-spaceclass_intro-solution$ mvn install
    
    [INFO] ------------------------------------------------------------------------
    [INFO] Reactor Summary:
    [INFO] 
    [INFO] lab07-solution 1.0-SNAPSHOT ......................... SUCCESS [  1.128 s]
...
5.2	Consider to improve your partitioning model according to the following requirements <br />
