...
a.	Go to %XAP_TRAINING_HOME%\Software\mysql-5.5.48-winx64.zip file and extract it to: c:\mysql <br /> 
b.	Note: Make sure you shut down any prior existing mysqls in your system. <br />
c.	Open a command window <br />
d.	Navigate c:\mysql\bin: <br /> 
...
17.2.4	Copy Persistency required jar files <br />
a.	Go to folder %XAP_TRAINING_HOME%\Labs\lib <br />
b.	Copy all files to folder %XAP_TRAINING_HOME%\gigaspaces\lib\optional\pu-common <br />
17.2.5	Configure your space to be mirror service aware. <br /.
a.	Modify your embedded Space Pu.xml. mirrored="true" space element tag (Hint: BillBuddy_space pu.xml) <br />
17.2.6	Map the data model to tables (using Hibernate. we will use annotations.) <br />
...
17.2.7	Configure the mirror service. <br />
...
17.2.8	The following tasks will make it clearer how to implement a Mirror service. <br />
...
17.2.9	Make sure you have a Database ready for use.
We will using MySQL db instance. <br />
a.	Make sure you have the MySQL instance up and running (see section 13.1.1 (e) )

17.2.10	Jar the BillBuddyPersistency project. Make sure to include the BillBuddyModel in the Jar. <br />
17.2.11	Deploy and test the Mirror service (and your space). <br />
...
17.2.12	Only for Windows - Open Relational Database Windows <br />
...
17.2.13	Only for Linux - Open Relational Database <br />
...
17.2.14	Only for Mac  - Open Relational Database <br />
...
17.2.15	Monitoring the Mirror service
